...
from src.menu_management.schemas import CreateMenu, CreateSubmenu, CreateDish
...
class TestCrud:
    ...
    def test_add_menu(cls):
        ...
        assert added_menu.get("submenus_count") == 0
        assert added_menu.get("dishes_count") == 0
    ...
    def test_add_submenu(cls):
        ...
        assert added_submenu.get("dishes_count") == 0
        added_menu = MenuService.get_menu(cls.menu_id)
        assert added_menu.get("submenus_count") == 1
        assert added_menu.get("dishes_count") == 0
    ...
    def test_add_two_dish(cls):
        ...
        for dish in dishes:
            new_dish = DishService.post_dish(cls.submenu_id, dish)
    ...
    def test_check_menu(cls):
        ...
        assert menu.get("submenus_count") == 1
        assert menu.get("dishes_count") == 2
    ...
    def test_delete_submenu(cls):
        ...
        SubmenuService.delete(cls.submenu_id)
